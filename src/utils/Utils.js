...
export const getGridBgColor = (theme, quartile = 1) => {
    switch(theme) {
        case blueTheme: return blueThemeBg[quartile - 1];
        case greenTheme: return greenThemeBg[quartile - 1];
        case redTheme: return redThemeBg[quartile - 1];
        default: return '';
    }
};